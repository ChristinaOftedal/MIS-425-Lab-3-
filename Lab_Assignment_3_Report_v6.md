...
![](report_images/figure1_model1_confusion_matrix_v6.png)

*Figure 1. Model 1 (ehcalabres) — predicted vs. actual emotion,
confusion matrix over all 240 clips.*

![](report_images/figure2_model2_confusion_matrix_v6.png)
...
![](report_images/figure3_confidence_comparison_v6.png)

*Figure 3. Confidence score distributions for both models, relative to
the 1/8 chance level.*

![](report_images/figure4_per_emotion_accuracy_v6.png)
