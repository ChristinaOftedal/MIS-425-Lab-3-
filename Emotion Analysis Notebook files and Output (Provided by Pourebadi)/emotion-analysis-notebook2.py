...
# Simple Emotion Prediction Analysis on
# Exploring the relationships between predicted emotions, probabilities, and actual emotions in our dataset.
#
# FIX: this script and emotion-analysis-notebook.py both used to point at the exact same
...
# this script produced didn't jibe with evaluate_results.py's confusion matrix for Model 2.
# Pointing this script at its own dedicated CSV (emotion_results_Model_2.csv, which already
...
path_option_1 = Path("emotion_results_Model_2.csv")
...
# FIX: this file already ships a real "True Emotion" ground-truth column. Use it directly
# instead of re-deriving from the filename and risking a spelling mismatch with 'emotion'.
...
image_out_path = Path("prediction_patterns_heatmap2.png")
...
# =====================================================================
report_path = Path("ravdess_summary_report_Model_2.txt")

try:
    with open(report_path, "w", encoding="utf-8") as f:
        f.write("==================================================\n")
        f.write("      RAVDESS EMOTION ANALYSIS SUMMARY REPORT\n")
        f.write("model=r-f/wav2vec-english-speech-emotion-recognition\n")
        f.write("==================================================\n\n")
