...
CSV_OUTPUT_PATH = Path("/workspaces/MIS-425-Lab-3-/emotion_results_Model_1.csv")
REPORT_OUTPUT_PATH = Path("/workspaces/MIS-425-Lab-3-/emotion_summary_report_Model_1.md")
HEATMAP_OUTPUT_PATH = Path("/workspaces/MIS-425-Lab-3-/emotion_distribution_heatmap_Model_1.png")
...
def main() -> None:
    ...
    pipe = pipeline(
        "audio-classification", model="ehcalabres/wav2vec2-lg-xlsr-en-speech-emotion-recognition"
    )
...
## System Overview
- **Model Used**: `ehcalabres/wav2vec2-lg-xlsr-en-speech-emotion-recognition`
...
"""
            ...
            logger.error(f"Error during reporting/visualization export: {export_error}")
    else:
        logger.warning("No classification data found. Report and heatmap generation skipped.")
