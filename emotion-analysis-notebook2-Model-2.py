...
path_option_1 = Path("/workspaces/MIS-425-Lab-3-/results/model2_results.csv")
...
image_out_path = Path("/workspaces/MIS-425-Lab-3-/prediction_patterns_heatmap_Model_2.png")
...
# =====================================================================
report_path = Path("/workspaces/MIS-425-Lab-3-/ravdess_summary_report_Model_2.txt")

try:
    with open(report_path, "w", encoding="utf-8") as f:
        f.write("==================================================\n")
        f.write("      MODEL 2 RAVDESS EMOTION ANALYSIS SUMMARY REPORT\n")
        f.write("==================================================\n\n")
