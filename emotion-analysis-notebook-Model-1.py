...
path_option_1 = Path("/workspaces/MIS-425-Lab-3-/results/model1_results.csv")
...
image_out_path = Path("/workspaces/MIS-425-Lab-3-/prediction_patterns_heatmap_Model_1.png")
...
# =====================================================================
report_path = Path("/workspaces/MIS-425-Lab-3-/ravdess_summary_report_model_1.txt")

try:
    with open(report_path, "w", encoding="utf-8") as f:
        f.write("==================================================\n")
        f.write("      MODEL 1 RAVDESS EMOTION ANALYSIS SUMMARY REPORT\n")
        f.write("==================================================\n\n")
